...
class TravelConfig(StrictModel):
    ...
    arrival_terminal_edge_weight: float = Field(default=0.30, ge=0.0, le=1.0)
    visitor_party_edge_weight: float = Field(default=0.60, ge=0.0, le=1.0)
    visitor_accommodation_edge_weight: float = Field(default=0.55, ge=0.0, le=1.0)
    visitor_host_household_edge_weight: float = Field(default=0.80, ge=0.0, le=1.0)
    visitor_transit_bus_edge_weight: float = Field(default=0.35, ge=0.0, le=1.0)
    visitor_transit_vehicle_edge_weight: float = Field(default=0.25, ge=0.0, le=1.0)
    visitor_community_indoor_edge_weight: float = Field(default=0.35, ge=0.0, le=1.0)
    visitor_community_outdoor_edge_weight: float = Field(default=0.18, ge=0.0, le=1.0)
