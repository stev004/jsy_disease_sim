 ...
 *
 * This whole folder belongs to the Simulate feature agent: routes, navigation,
 * providers, shared components and styles are already wired, so implementing
 * the view means editing only files under `src/views/simulate/`.
 *
 ...
 *   - `.view-simulate` styles are ported in `src/styles/views.css`
 */
export function SimulateView() {
  return (
    <section className="view view-simulate">
      <div className="wrap" style={{ padding: '28px 32px' }}>
        <h1 style={{ fontSize: 21, fontWeight: 700 }}>New scenario</h1>
      </div>
    </section>
  );
}
