...
**Budget:** 5 iterations · 6 codex runs. Spent: 4 runs (U1, U2, U2b accepted iter-1; U3 launched). Remaining: CI green at final tip + run-stop digest + terra trail audit (in flight).
...
- **U3** (relocation-guard) luna@high in `/private/tmp/jsy_v12_carryins`, stem `.../briefs/jos-u3-relocation-guard`, timebox 15 min.
