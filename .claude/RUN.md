...
2. G16 and G17 are MERGED (2026-09-05: `133a099`, `f5c246c`; `main` @ `f5c246c6b2c78860000fe6124dc018a151bd1a50`). Branch the corrective unit off `origin/main`. CI on the merge commit: see trail row `g16-g17-ci`.
