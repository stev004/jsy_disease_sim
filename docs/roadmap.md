...
- ◐ Remaining freezes IN FLIGHT (foreman v12-run2 iteration 1, 2026-09-04): JHU confirmed+deaths, respiratory report current + 3 Wayback editions, winter illness report 2024, annual population estimates; tables `covid_jhu_daily`, `population_estimates_annual`.
