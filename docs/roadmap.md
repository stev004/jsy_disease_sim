...
- ☑ **PROV-2** (2026-09-05, `fix/job-liveness-and-snapshot-eol` @ `c062d20`, merge = G17): exclusive `scheduler.lock`, worker token + `os.kill(pid,0)` liveness probe, live workers adopted on restart, dead/tokenless pids interrupted; T1–T3 — `docs/runs/2026-09-05-robustness-bundle-luna-report.md`.
