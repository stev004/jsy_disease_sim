...
- ◐ Exit gate IN FLIGHT (2026-09-05 00:49, iteration 3): Sol@high cold-start audit in a fresh clone at `9ac9d20` per `docs/research/v1_2/V1_2_EXIT_GATE.md`; verdict to be filed in `docs/audits/`. Calibration itself excluded.
